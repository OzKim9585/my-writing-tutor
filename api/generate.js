...
1. 합격(passed: true) 판정 기준:
   - 현재 단계(Step ${step})의 목적에 부합하는 내용인가? (예: Step 1은 추천 책 제목 소개만 완결되면 통과)
...
2. 문법 및 추천 요소 점검 주의사항 (절대 모든 문장에 강요 금지):
   - '목적의 to부정사(to + 동사원형)'와 '재귀대명사(-self, -selves)', '추천 요소(비교, 주제, 삽화, 감동)'는 전체 8문장을 쓰는 동안 적재적소에 자연스럽게 나누어 쓰는 과제 조건입니다.
   - 현재 문장에 이 요소들이 포함되어 있지 않더라도 **절대로 탈락(passed: false) 사유로 삼지 마세요.**
   - 현재 제출한 문장에 해당 요소가 쓰였는지 여부만 감지하여 detectedGrammar와 detectedCriteria의 boolean 값으로만 정확히 표기하세요.
